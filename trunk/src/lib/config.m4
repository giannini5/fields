...
M4_PHP_DEFINE('EMAIL_USER', M4_DB_EMAIL_USER);
M4_PHP_DEFINE('EMAIL_NAME', M4_DB_EMAIL_NAME);
M4_PHP_DEFINE('EMAIL_PASSWORD', M4_DB_EMAIL_PASSWORD);
M4_PHP_DEFINE('EMAIL_HOST', M4_DB_EMAIL_HOST);
M4_PHP_DEFINE('EMAIL_PORT', M4_DB_EMAIL_PORT);
