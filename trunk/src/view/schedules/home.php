 ...
 */
class View_Schedules_Home extends View_Schedules_Base {
    /**
    ...
    public function __construct($controller) {
        parent::__construct(self::SCHEDULE_HOME_PAGE, $controller);
    }
    ...
    public function renderLoadFacilitiesFromFile()
    {
        ...
        print "
            <table bgcolor='lightyellow' valign='top' style='margin-left:25px' width='700' border='1' cellpadding='5' cellspacing='0'>
                ...
                <tr>
                    <form enctype='multipart/form-data' method='POST' action='" . self::SCHEDULE_HOME_PAGE . $this->m_urlParams . "'>
    ...
    public function renderLogin() {
        ...
        print "
            <form method='post' action='" . self::SCHEDULE_HOME_PAGE . $this->m_urlParams . "'>";
