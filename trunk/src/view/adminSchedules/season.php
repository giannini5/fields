...
class View_AdminSchedules_Season extends View_AdminSchedules_Base {
    ...
    private function _printCreateSeasonForm($maxColumns) {
        ...
        $this->displayCalendarDateSelector($maxColumns, View_Base::START_DATE, 'First Day of Season', '2018-09-08');
        $this->displayCalendarDateSelector($maxColumns, View_Base::END_DATE, 'Last Day of Season', '2018-11-11');
