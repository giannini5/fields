...
class Season extends Domain
{
    ...
    public function __get($propertyName)
    {
        switch ($propertyName) {
            case "id":
                return $this->seasonOrm->id;
                break;

            case "name":
                return $this->seasonOrm->name;
                break;

            case "startDate":
                return $this->seasonOrm->startDate;
                break;

            case "endDate":
                return $this->seasonOrm->endDate;
                break;

            case "startTime":
                return $this->seasonOrm->startTime;
                break;

            case "endTime":
                return $this->seasonOrm->endTime;
                break;

            case "daysOfWeek":
                return $this->seasonOrm->daysOfWeek;
                break;

            case "enabled":
                return $this->seasonOrm->enabled;
                break;
