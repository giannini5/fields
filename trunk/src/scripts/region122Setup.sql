...
call sp_addField(@leagueName, @facilityName, 'L', 1);
...
call sp_addDivisionField(@leagueName, @u5, @facilityName, 'L');
call sp_addDivisionField(@leagueName, @u6, @facilityName, 'L');
...
call sp_addField(@leagueName, @facilityName, '5A', 0);
call sp_addField(@leagueName, @facilityName, '5B', 0);
