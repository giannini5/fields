...
abstract class Controller_AdminReferee_Base extends Controller_Base
{
    ...
    {
        parent::__construct(self::REFEREE_ADMIN_COOKIE);
    ...
    public function signOut()
    {
        ...
        Model_Fields_Session::Delete($this->m_coordinator->id, Model_Fields_Session::REFEREE_COORDINATOR_USER_TYPE, 0);
        $this->m_session            = null;
        ...
        try {
            if ($this->m_operation == View_Base::SUBMIT) {
                ...
                if ($this->m_coordinator->password != $this->m_password) {
                    ...
                    $this->createSession($this->m_coordinator->id, Model_Fields_Session::REFEREE_COORDINATOR_USER_TYPE, 0);
                }
            }
    ...
    private function _constructFromSessionId($sessionId) {
        try {
            ...
            if (isset($this->m_session) and $this->m_session->userType == Model_Fields_Session::REFEREE_COORDINATOR_USER_TYPE) {
